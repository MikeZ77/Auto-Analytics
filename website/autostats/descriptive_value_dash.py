...
app.layout = html.Div( children=[
	...
	dcc.Tabs(id="dashboard_type", value='descriptive', children=[
    ...
    ],style={'margin-left':'4px', 'margin-right':'50%'}),
...
@app.callback(
	...
	[dash.dependencies.Input('dashboard_type','value'),
	dash.dependencies.Input('vehicle_data','value'),
	])
def init_graphs(tab_value, vehicle_values):

	if tab_value == 'descriptive':
	#MAIN -----------------------------------------------------------------------------------------------------------------------
